namespace Program2___projekt_dla_facetów__
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // saveJoe
            // 
            saveJoe.Location = new Point(12, 188);
            saveJoe.Name = "saveJoe";
            saveJoe.Size = new Size(107, 23);
            saveJoe.TabIndex = 7;
            saveJoe.Text = "Zapisz Joego";
            saveJoe.UseVisualStyleBackColor = true;
            saveJoe.Click += saveJoe_Click;
            // 
            // loadJoe
            // 
            loadJoe.Location = new Point(125, 188);
            loadJoe.Name = "loadJoe";
            loadJoe.Size = new Size(107, 23);
            loadJoe.TabIndex = 8;
            loadJoe.Text = "Wczytaj Joego";
            loadJoe.UseVisualStyleBackColor = true;
            loadJoe.Click += loadJoe_Click;
            // 
            // Form1
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(244, 223);
            Controls.Add(loadJoe);
            Controls.Add(saveJoe);
        ...
        private Button saveJoe;
        private Button loadJoe;
    }
}